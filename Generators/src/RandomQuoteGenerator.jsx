...
import "./RandomQuoteGenerator.css"; // Import your CSS file

export default class RandomQuoteGenerator extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleRandomQuote = () => {
    ...
    const randomQuote =
      teluguQuotes[Math.floor(Math.random() * teluguQuotes.length)];
  ...
  render() {
    return (
      <div className="generator-section">
        ...
        <div className="quote-generator-box">{this.state.quote}</div>
        <div className="quote-generator-label">Telugu Quote</div>
      </div>
    );
  }
}
